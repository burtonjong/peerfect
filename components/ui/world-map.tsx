...
export default function WorldMap({
  ...
  const svgMap = map.getSVG({
    ...
    shape: "circle",
    backgroundColor: theme === "dark" ? "black" : "#FAFAFA00",
  });
          ...
          return (
            <g key={`path-group-${i}`}>
              <motion.path
                ...
                animate={{
                  pathLength: [0, 1, 0], // Animate to point B and then away from point A
                  opacity: [1, 1, 0], // Fade out the line as it animates away
                }}
                transition={{
